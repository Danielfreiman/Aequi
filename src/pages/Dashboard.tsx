import { AlertTriangle, ArrowRight, Banknote, Bell, Calendar, Download, Receipt, TrendingUp } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-surface-light p-6 rounded-2xl shadow-soft border border-gray-100 flex flex-col justify-between h-40 group hover:border-primary/30 transition-all">
          <div className="flex justify-between items-start">
            ...
            <span className="px-2 py-1 bg-gray-100 text-gray-600 text-xs font-bold rounded-full">Previsto: Amanhã</span>
          </div>
          <div>
