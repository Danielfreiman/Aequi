    ...
    <div className="min-h-screen bg-[#f7f4ec] text-[#0f1720]">
      <div className="relative overflow-hidden">
                ...
                <div className="p-6 rounded-3xl bg-white/90 border border-[#d9d1c3] shadow-[0_18px_40px_rgba(12,38,27,0.12)] space-y-4">
                  ...
                  <div className="grid sm:grid-cols-2 gap-3">
                    ...
                    <div className="p-4 rounded-2xl bg-white border border-[#d9d1c3] text-[#103826]">
                      ...
                      <p className="text-2l font-black">R$ 11.200</p>
        ...
        <footer className="border-t border-[#d9d1c3] bg-white/80">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col md:flex-row md:items-center md:justify-between gap-6 text-[#3f4d46]">
            <div>
              <p className="text-sm font-semibold text-[#0f2c1f]">Aequi Partner Dashboard</p>
              <p className="text-xs">Conciliação e controle financeiro para restaurantes iFood.</p>
            </div>
            <div className="flex flex-wrap gap-4 text-sm">
              <a href="/login" className="hover:text-[#0f2c1f]">Login</a>
              <a href="#planos" className="hover:text-[#0f2c1f]">Planos</a>
              <a href="#beneficios" className="hover:text-[#0f2c1f]">Benefícios</a>
            </div>
